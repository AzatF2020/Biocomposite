    ...
    return t = e, (n = [{
      ...
      value: function () {
        document.addEventListener("click", function (e) {
          ...
          !this._isMoved && e.target instanceof Element && !e.target.classList.contains("modal__wrapper") || (this._overlayChecker = !0)
        }.bind(this)), document.addEventListener("mouseup", function (e) {
          if (!this._isMoved && e.target instanceof Element && this._overlayChecker && e.target.classList.contains("modal__wrapper")) return e.preventDefault(), this._overlayChecker, void this.close();
      ...
      value: function () {
        if (this.config.backscroll) {
          ...
          if (!0 === this.isOpened) return t.style.marginRight = "", e.map((function (e) {
            e.style.marginRight = ""
